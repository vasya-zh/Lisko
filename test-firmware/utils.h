...
#define DISP_RES_PORT gpioPortA
...
#define TOUCH_RES_PORT gpioPortA
#define TOUCH_RES_PIN 7

#define INT_PORT gpioPortB
#define INT_PIN 1

#define MCU_OK_PORT gpioPortA
#define MCU_OK_PIN 3



#define POW_2V8(x) (x ? GPIO_PinOutSet : GPIO_PinOutClear)(POW_EN_PORT, POW_EN_PIN)
#define TOUCH_RES(x) (x ? GPIO_PinOutSet : GPIO_PinOutClear)(TOUCH_RES_PORT, TOUCH_RES_PIN)

#define MCU_OK(x) (x ? GPIO_PinOutClear : GPIO_PinOutSet)(MCU_OK_PORT, MCU_OK_PIN)
