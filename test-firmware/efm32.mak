...
#Additional flags
PREPROCESSOR_MACROS += ARM_MATH_CM4 flash_layout EFM32PG23B200F512IM40
INCLUDE_DIRS += $(BSP_ROOT)/EFM32PG23/Devices/Include $(BSP_ROOT)/CMSIS $(BSP_ROOT)/framework/emlib/config $(BSP_ROOT)/framework/emlib/inc $(BSP_ROOT)/framework/emlib/init/gpio_simple $(BSP_ROOT)/framework/emlib/init/gpio_simple/config
LIBRARY_DIRS += 
LIBRARY_NAMES += 
...
CXXFLAGS += 
ASFLAGS += 
LDFLAGS += --specs=nano.specs -u _printf_float --specs=nosys.specs -Wl,--no-warn-rwx-segments
COMMONFLAGS += -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard
LINKER_SCRIPT := $(BSP_ROOT)/EFM32PG23/LinkerScripts/EFM32PG23B200F512IM40_flash.lds
